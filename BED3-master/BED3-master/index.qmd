...
På denne siden finner du relevant informasjon om kurset ([Om kurset](kursinformasjon.qmd)), formelarket ([formelark](formelark.qmd)), og teorivideoer knyttet til kursets moduler om investeringsanalyse og finansielle markeder og kontrakter ([kursinnhold](kursinnhold.qmd)).
